...
export const metadata = {
    title: "Women's Collection | Fashion Beauty Lifestyle | Pakistan",
    description: "Explore our women's collection. Stylish clothing, footwear, beauty products and accessories for Pakistani women.",
    keywords: ["women fashion pakistan", "women clothing", "women shoes", "women accessories", "women beauty"],
};
...
const Page = async ({ searchParams }) => {
    ...
    let query = {
        availability: { $gt: 0 },
        $or: [
            { productFor: { $regex: /women/i } },
            { tags: { $in: ['women', 'female', 'womens', 'ladies', 'woman'] } }
        ]
    };
    ...
    const categoryData = {
        ...
        description: "Explore our women's collection. Stylish clothing, footwear, beauty products and accessories.",
        slug: "womens",
    ...
    return (
        <>
            ...
            />
            <ProductsPageLayout product={product} category={category} tag={tag} collectionTitle="Women's Collection" collectionDescription="Fashion, beauty and lifestyle for women"
                bannerImage="https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1200&h=400&fit=crop&q=80" />
        </>
    );
};
