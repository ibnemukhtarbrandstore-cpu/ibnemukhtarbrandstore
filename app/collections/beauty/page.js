...
export const metadata = {
    title: "Beauty & Personal Care | Skincare Cosmetics | Pakistan",
    description: "Premium beauty and personal care products. Skincare, cosmetics, fragrances and grooming essentials.",
    keywords: ["beauty products pakistan", "skincare", "cosmetics", "makeup", "fragrance", "grooming"],
};
...
const Page = async ({ searchParams }) => {
    ...
    let query = {
        availability: { $gt: 0 },
        $or: [
            { tags: { $in: ['beauty', 'skincare', 'cosmetic', 'makeup', 'fragrance', 'grooming', 'perfume'] } },
            { category: { $in: ['beauty', 'cosmetics', 'skincare'] } }
        ]
    };
    ...
    return (
        <>
            ...
            />
            <ProductsPageLayout product={product} category={category} tag={tag} collectionTitle="Beauty & Personal Care" collectionDescription="Look and feel your best"
                bannerImage="https://images.unsplash.com/photo-15964625022 78-27bfdc403348?w=1200&h=400&fit=crop&q=80" />
        </>
    );
};
