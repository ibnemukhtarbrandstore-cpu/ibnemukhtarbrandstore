...
export const metadata = {
    title: "Summer Collection 2025 | Light & Cool | Pakistan",
    description: "Beat the heat with our summer essentials. Light, breathable clothing perfect for Pakistani summers.",
    keywords: ["summer collection pakistan", "summer wear", "light clothing", "breathable fabric", "summer fashion"],
};
...
const Page = async ({ searchParams }) => {
    ...
    let query = {
        availability: { $gt: 0 },
        $or: [
            { tags: { $in: ['summer', 'cool', 'light', 'breathable', 'shorts', 'tshirt', 'cotton'] } },
            { category: { $in: ['tshirts', 'shorts', 'sandals'] } }
        ]
    };
    ...
    const categoryData = {
        ...
        description: "Beat the heat with our summer essentials. Light and breathable clothing.",
        slug: "summer",
    ...
    return (
        <>
            ...
            />
            <ProductsPageLayout product={product} category={category} tag={tag} collectionTitle="Summer Collection" collectionDescription="Stay cool and comfortable"
