...
export const metadata = {
    title: "Electronics & Gadgets | Tech Accessories | Pakistan",
    description: "Latest electronics and tech accessories at competitive prices. Mobile accessories, audio devices and more.",
    keywords: ["electronics pakistan", "gadgets", "tech accessories", "mobile accessories", "audio devices", "smart devices"],
};
...
const Page = async ({ searchParams }) => {
    ...
    let query = {
        availability: { $gt: 0 },
        $or: [
            { tags: { $in: ['electronics', 'gadgets', 'tech', 'device', 'phone', 'audio', 'headphones', 'charger'] } },
            { category: { $in: ['electronics', 'gadgets', 'tech'] } }
        ]
    };
    ...
    const categoryData = {
        ...
        description: "Latest electronics and tech accessories at competitive prices.",
        slug: "electronics",
    ...
    return (
        <>
            ...
            />
            <ProductsPageLayout product={product} category={category} tag={tag} collectionTitle="Electronics & Gadgets" collectionDescription="Stay connected with latest tech"
