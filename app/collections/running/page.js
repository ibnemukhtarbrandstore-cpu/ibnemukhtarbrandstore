...
export const metadata = {
    title: "Running Gear | Shoes & Apparel | Pakistan",
    description: "Complete running gear for runners. Running shoes, apparel and accessories for your best performance.",
    keywords: ["running shoes pakistan", "running gear", "running apparel", "jogging", "marathon training"],
};
...
const Page = async ({ searchParams }) => {
    ...
    let query = {
        availability: { $gt: 0 },
        $or: [
            { tags: { $in: ['running', 'jogging', 'marathon', 'athletic', 'runner'] } }
        ]
    };
    ...
    const categoryData = {
        name: "Running Gear",
        description: "Complete running gear for runners. Shoes, apparel and accessories.",
        slug: "running",
    ...
    return (
        <>
            ...
            />
            <ProductsPageLayout product={product} category={category} tag={tag} collectionTitle="Running Gear" collectionDescription="Gear up for your best run"
                bannerImage="https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=1200&h=400&fit=crop&q=80" />
        </>
    );
};
