...
export const metadata = {
    title: "Sports & Athletic Wear | Gym Fitness | Pakistan",
    description: "High-performance sports gear and athletic wear for active lifestyles. Gym, running, and training essentials.",
    keywords: ["sports pakistan", "athletic wear", "gym clothes", "fitness gear", "running shoes", "training apparel"],
};
...
const Page = async ({ searchParams }) => {
    ...
    let query = {
        availability: { $gt: 0 },
        $or: [
            { tags: { $in: ['sports', 'athletic', 'fitness', 'gym', 'running', 'training', 'active', 'workout'] } },
            { category: { $in: ['sports', 'athletic', 'fitness'] } }
        ]
    };
    ...
    const categoryData = {
        ...
        description: "High-performance sports gear and athletic wear for active lifestyles.",
        slug: "sports",
    ...
    return (
        <>
            ...
            />
            <ProductsPageLayout product={product} category={category} tag={tag} collectionTitle="Sports & Athletic" collectionDescription="Gear up for peak performance"
                bannerImage="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=1200&h=400&fit=crop&q=80" />
        </>
    );
};
