...
export const metadata = {
    title: "Accessories | Bags Wallets Jewelry | Pakistan",
    description: "Complete your look with stylish accessories. Bags, wallets, jewelry, watches and more at best prices.",
    keywords: ["accessories pakistan", "bags", "wallets", "jewelry", "watches", "belts", "sunglasses"],
};
...
const Page = async ({ searchParams }) => {
    ...
    let query = {
        availability: { $gt: 0 },
        $or: [
            { tags: { $in: ['accessory', 'bag', 'wallet', 'jewelry', 'watch', 'belt', 'hat', 'sunglasses', 'scarf'] } },
    ...
    return (
        <>
            ...
            />
            <ProductsPageLayout product={product} category={category} tag={tag} collectionTitle="Accessories" collectionDescription="The perfect finishing touch"
                bannerImage="https://images.unsplash.com/photo-1532545261798-1ea38921e7c3?w=1200&h=400&fit=crop&q=80" />
        </>
    );
};
