...
export const metadata = {
    title: "Formal Wear | Office & Business | Pakistan",
    description: "Professional formal wear for office and special occasions. Look sharp and confident.",
    keywords: ["formal wear pakistan", "office clothing", "business attire", "professional wear", "wedding clothes"],
};
...
const Page = async ({ searchParams }) => {
    ...
    let query = {
        availability: { $gt: 0 },
        $or: [
            { tags: { $in: ['formal', 'office', 'business', 'professional', 'wedding', 'suit'] } }
        ]
    };
    ...
    const categoryData = {
        name: "Formal Wear",
        description: "Professional formal wear for office and special occasions.",
        slug: "formal",
    ...
    return (
        <>
            ...
            />
            <ProductsPageLayout product={product} category={category} tag={tag} collectionTitle="Formal Wear" collectionDescription="Professional style for every occasion"
                bannerImage="https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=1200&h=400&fit=crop&q=80" />
        </>
    );
};
