...
export const metadata = {
    title: "Men's Collection | Clothing Shoes Accessories | Pakistan",
    description: "Complete men's collection. Jackets, shoes, accessories and grooming products for modern Pakistani men.",
    keywords: ["men fashion pakistan", "men clothing", "men shoes", "men accessories", "men grooming"],
};
...
const Page = async ({ searchParams }) => {
    ...
    let query = {
        availability: { $gt: 0 },
        $or: [
            { productFor: { $regex: /men/i } },
            { tags: { $in: ['men', 'male', 'mens', 'man'] } }
        ]
    };
    ...
    const categoryData = {
        ...
        description: "Complete men's collection. Jackets, shoes, accessories and grooming products.",
        slug: "mens",
    ...
    return (
        <>
            ...
            <ProductsPageLayout
                ...
                collectionDescription="Fashion and essentials for men"
                bannerImage="https://images.unsplash.com/photo-1490578474895-699cd4e2cf59?w=1200&h=400&fit=crop&q=80"
            />
        </>
    );
};
