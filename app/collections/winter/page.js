...
export const metadata = {
    title: "Winter Collection 2025 | Jackets Hoodies | Pakistan",
    description: "Stay warm this winter with our premium collection. Winter jackets, hoodies, sweaters and thermal wear.",
    keywords: ["winter collection pakistan", "winter jackets", "hoodies", "warm clothing", "thermal wear"],
};
...
const Page = async ({ searchParams }) => {
    ...
    let query = {
        availability: { $gt: 0 },
        $or: [
            { tags: { $in: ['winter', 'warm', 'jacket', 'hoodie', 'coat', 'thermal', 'sweater'] } },
            { category: { $in: ['jackets', 'hoodies', 'sweaters', 'coats'] } }
        ]
    };
    ...
    const categoryData = {
        ...
        description: "Stay warm this winter with our premium collection. Winter jackets, hoodies and thermal wear.",
        slug: "winter",
        productCount: Object.keys(product).length,
        parentCategory: "Seasonal Collections"
    };
    ...
    return (
        <>
            ...
            <ProductsPageLayout
                ...
                collectionDescription="Premium winter essentials to keep you warm"
                bannerImage="https://images.unsplash.com/photo-1551028719-00167b16eac5?w=1200&h=400&fit=crop&q=80"
            />
        </>
    );
};
