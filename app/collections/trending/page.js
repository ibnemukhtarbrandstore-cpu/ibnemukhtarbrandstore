...
export const metadata = {
    title: "Trending Now | Popular Products | Pakistan",
    description: "What's trending now. Most viewed and popular products this week at Ibnemukhtar Brand Store.",
    keywords: ["trending pakistan", "popular products", "viral items", "hot products", "trending fashion"],
};
...
const Page = async ({ searchParams }) => {
    ...
    const categoryData = {
        name: "Trending Now",
        description: "What's trending now. Most viewed and popular products this week.",
        slug: "trending",
        productCount: Object.keys(product).length,
        parentCategory: "Popular Collections"
    };
    ...
    return (
        <>
            ...
            />
            <ProductsPageLayout product={product} category={category} tag={tag} collectionTitle="Trending Now" collectionDescription="Hottest products this week"
                bannerImage="https://images.unsplash.com/photo-1607082349566-187342175e2f?w=1200&h=400&fit=crop&q=80" />
        </>
    );
};
