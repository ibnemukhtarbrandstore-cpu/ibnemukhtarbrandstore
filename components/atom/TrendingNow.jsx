    ...
    return (
        <section className="container mx-auto px-4 py-8 md:py-12">
            ...
            <div className="flex justify-between items-center mb-6 md:mb-8">
                <div>
                    <h2 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-orange-400 via-red-500 to-pink-600 bg-clip-text text-transparent">
                        🔥 Trending Now
                    </h2>
                ...
                <button
                    ...
                    className="px-4 py-2 md:px-6 md:py-3 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-lg font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105 text-sm md:text-base"
                >
                    View All
                </button>
            </div>
...
function ProductCard({ product, onClick, mobile = false }) {
    ...
    return (
        <div
            className={`group relative bg-white rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 cursor-pointer border border-gray-100 hover:border-red-400 overflow-hidden ${cardClasses}`}
            onClick={onClick}
        >
